...
Once an Order is created, no trade or tranfer of tokens happens immediately. The Maker of the Order must wait for a taker to create a trade against an order, at which point Token balances in the Smart Contract are exchanged between the maker and taker.

GammaDEX displays lists of buy and sell orders ("Order Books", "Books", "Book") for Tokens. The orders that appear in the Book are gathered from GammaDEX directly and other third parties that gather EtherDelta-compatible orders. Orders created on the GammaDEX website are also published to other third parties, though this happens with no guarantee of content, accuracy or timeliness. By using this service you agree to Orders being published to third parties in this way and with no guarantee.
...
GammaDEX allows users to trade Ethereum-based tokens that conform to the ERC20 Token Standard Interface. This can include other Ethereum Token Standards that build on top of the ERC20 standard. GammaDEX does not guarantee the accuracy or authenticity of the Tokens you can view or trade on the platform and you should thoroughly research the Token contract details you intend to trade. GammaDEX does not own or control any of these Tokens, and You agree to not hold GammaDEX responsible or liable for losses incurred from depositing, withdrawing, creating orders or trading any such Tokens or acts or omissions of the Token Developers, under any circumstances. GammaDEX does not in any way warrant the accuracy, reliability, security, completeness, usefulness, non-infringement, or quality of the Tokens listed on the platform.

##### Fees

GammaDEX does not charge a fee for using it's services.

Third Party Applications may charge the user a fee for actions including (but not limited to) executing a trade. You acknowledge and agree that all costs and fees associated with trading through Third Party Applictions shall be at your own cost and responsibility. You should read the fee schedule associated with any Third Party Applications. You understand, agree, and accept that GammaDEX makes no guarantee about the accuracy of Third Party fee schedules and has no obligation to display, keep accurate or keep up-to-date Third Party fee schedules displayed on the GammaDEX website.

The Ethereum Network will impose a charge for executing transactions on your behalf, known as 'gas'. Gas is payable directly from the User's wallet to the Ethereum Network, when a transaction is authorized and sent from GammaDEX. You acknowledge and agree that all gas fees shall be at your own cost and responsibility. GammaDEX does not guarantee the accuracy, timeliness, validity or integrity of either (a) gas prices displayed on the website and used when submitting transactions (b) gas limits used when submitting transactions and you agree not to hold GammaDEX responsible for losses of any form incurred from these gas prices or gas limits.
