...
export default {
    ...
    CLEAR_SELECTED_WALLET_TYPE: "CLEAR_SELECTED_WALLET_TYPE",
    ...
    MESSAGE_RECEIVED_TOKENS: "MESSAGE_RECEIVED_TOKENS",
    MESSAGE_REQUESTED_TOKEN_BALANCES: "MESSAGE_REQUESTED_TOKEN_BALANCES",
    MESSAGE_RECEIVED_TOKEN_BALANCES: "MESSAGE_RECEIVED_TOKEN_BALANCES",
    TOKEN_BALANCES_RETRIEVAL_FAILED: "TOKEN_BALANCES_RETRIEVAL_FAILED",
    TOKEN_BALANCE_SORT: "TOKEN_BALANCE_SORT",
    TOKEN_BALANCE_FILTER_LOW_VALUE: "TOKEN_BALANCE_FILTER_LOW_VALUE",
    SELECT_USER_GUIDE: "SELECT_USER_GUIDE",
    TOKEN_VOLUME_DAY_VOLUME_REQUEST_SENT: "TOKEN_VOLUME_DAY_VOLUME_REQUEST_SENT",
    TOKEN_VOLUME_DAY_VOLUME_REQUEST_FAILED: "TOKEN_VOLUME_DAY_VOLUME_REQUEST_FAILED",
    TOKEN_VOLUME_DAY_VOLUME_REQUEST_RETRIEVED: "TOKEN_VOLUME_DAY_VOLUME_REQUEST_RETRIEVED",
    TOKEN_VOLUME_DAY_CHANGE_DATE: "TOKEN_VOLUME_DAY_CHANGE_DATE",
    TOKEN_VOLUME_DAY_CHANGE_DISPLAY_NUM: "TOKEN_VOLUME_DAY_CHANGE_DISPLAY_NUM",
    TOKEN_VOLUME_DAY_CHANGE_SHOW_OTHER: "TOKEN_VOLUME_DAY_CHANGE_SHOW_OTHER",
    TOKEN_VOLUME_WEEK_CHANGE_DATE: "TOKEN_VOLUME_WEEK_CHANGE_DATE",
    TOKEN_VOLUME_WEEK_CHANGE_DISPLAY_NUM: "TOKEN_VOLUME_WEEK_CHANGE_DISPLAY_NUM",
    TOKEN_VOLUME_WEEK_CHANGE_SHOW_OTHER: "TOKEN_VOLUME_WEEK_CHANGE_SHOW_OTHER",
    TOKEN_VOLUME_WEEK_VOLUME_REQUEST_SENT: "TOKEN_VOLUME_WEEK_VOLUME_REQUEST_SENT",
    TOKEN_VOLUME_WEEK_VOLUME_REQUEST_FAILED: "TOKEN_VOLUME_WEEK_VOLUME_REQUEST_FAILED",
    TOKEN_VOLUME_WEEK_VOLUME_REQUEST_RETRIEVED: "TOKEN_VOLUME_WEEK_VOLUME_REQUEST_RETRIEVED",
    TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_FROM_DATE: "TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_FROM_DATE",
    TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_TO_DATE: "TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_TO_DATE",
    TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_DISPLAY_NUM: "TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_DISPLAY_NUM",
    TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_SHOW_OTHER: "TOKEN_VOLUME_RANGE_BY_DAY_CHANGE_SHOW_OTHER",
    TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_SENT: "TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_SENT",
    TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_FAILED: "TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_FAILED",
    TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_RETRIEVED: "TOKEN_VOLUME_RANGE_BY_DAY_VOLUME_REQUEST_RETRIEVED",
    TOKEN_VOLUME_RANGE_BY_DAY_RANGE_TOO_WIDE: "TOKEN_VOLUME_RANGE_BY_DAY_RANGE_TOO_WIDE",
    METAMASK_ACCOUNT_APPROVAL: "METAMASK_ACCOUNT_APPROVAL",
}
