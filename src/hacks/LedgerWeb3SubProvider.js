                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 11:
                            ...
                            addressToPathMap[address.address.toUpperCase()] = _path
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            var msgDataFrom = msgData.from ? msgData.from.toUpperCase() : ""
                            path = addressToPathMap[msgDataFrom]
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            var txDataFrom = txData.from ? txData.from.toUpperCase() : ""
                            path = addressToPathMap[txDataFrom]
